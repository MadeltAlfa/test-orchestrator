...
<div class="max-w-xl mx-auto space-y-6">
    <div class="flex items-center gap-4">
        ...
        <h1 class="text-2xl font-headline font-extrabold text-primary">Tambah Posisi</h1>
    </div>

    <div class="card-premium p-6">
        <form action="{{ route('superadmin.positions.store') }}" method="POST" class="space-y-5">
            @csrf
            <div>
            ...
            <div>
                ...
                <input type="text" name="name" value="{{ old('name') }}"
                    ...
                    placeholder="Contoh: Penjaga Gawang">
            ...
            <div>
                ...
                <textarea name="description" rows="3"
                    ...
                    placeholder="Deskripsi singkat posisi...">{{ old('description') }}</textarea>
